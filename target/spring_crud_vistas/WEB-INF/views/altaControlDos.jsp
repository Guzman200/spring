...
<body class="bg-dark">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="input-group pt-3">
                                ...
                                <input type="text" class="form-control" id="encabezado"
                            ...
                            <div class="input-group pt-3">
                                ...
                                <select class="form-control" name="tipoTarjeta" id="selectTabla">
                                    <option value="default" >Seleccione un tipo de tabla</option>
                                </select>
                            </div>
    ...
    <script src="${pageContext.request.contextPath}/js/altaControlDos.js"></script>

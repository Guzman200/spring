...
<html lang="en">
  ...
  <body class="bg-dark">
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <button id="addTypeTabla" class="btn btn-outline-primary" data-toggle="modal" data-target="#modalAgregarTypeTabla">
                            Agregar Type Tabla
                        </button>
                        <!--
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped tablaTypeTabla">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Tipo</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-info btnEdit" data-toggle="modal" data-target="#modalEditarTypeTabla">EDIT</button>
                                        <button class="btn btn-danger btnDelete" data-toggle="modal" data-target="#modalEliminarTypeTabla">DELETE</button>
                                    </td>
                                </tr>
                                <tr>
                                    <td>2</td>
    ...
    <div id="modalAgregarTypeTabla" class="modal fade" role="dialog">

        <div class="modal-dialog">

            <div class="modal-content">

                <form id="formAddTypeTabla">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel">Alta Tipo Tabla</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <!-- ENTRADA PARA LA DESCRIPCION DE LA TABLA -->
                        <div class="input-group pt-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text">
                                    <i class="fas fa-user"></i>
    ...
    <div id="modalEditarTypeTabla" class="modal fade" role="dialog">

        <div class="modal-dialog">

            <div class="modal-content">

                <form id="formEditTypeTabla">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel">Editar Tipo Tabla</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
    ...
    <script src="${pageContext.request.contextPath}/js/type_tabla.js"></script>

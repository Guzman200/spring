                ...
                <div class="modal-content">
                    ...
                    <form id="formAddTypeCard">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row pt-4">
                                <div class="col-12">
                                    <div style="overflow: scroll; height: 200px" id="divIconos">
                    ...
                    <form id="formAEditTypeCard">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="input-group pt-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">
                                        <i class="" id="i_iconoEdit"></i>
                                    </span>
                                </div>
                                <input type="text" class="form-control" id="iconoEdit"
                                       placeholder="Icono" required>
                            </div>

                            <div class="row pt-4">
                                <div class="col-12">
                                    <div style="overflow: scroll; height: 200px" id="divIconosEdit">
                                        <!--<span class="fas fa-user"></span>-->
